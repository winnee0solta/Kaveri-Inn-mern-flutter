...
class HallBookScreen extends StatefulWidget {
 final hall;
  HallBookScreen({Key key, @required this.hall}) : super(key: key);

  @override
  _HallBookScreenState createState() => _HallBookScreenState();
}

class _HallBookScreenState extends State<HallBookScreen> {
final GlobalKey<ScaffoldState> _scaffoldKey = new GlobalKey<ScaffoldState>();
  ...
  Future<void> _bookData() async {
    ...
    var response = await http
        .post(ApiRoutes.bookhall + "/" + widget.hall['_id'], headers: {
